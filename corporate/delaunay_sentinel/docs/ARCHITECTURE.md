# Arquitectura - delaunay_sentinel

## Visión General

delaunay_sentinel es un módulo de ciberseguridad implementado como parte del **Snocomm Security Suite**.

- **Misión**: The Gunslinger
- **Rol de Seguridad**: malware-analyzer
...
La clase `DelaunaySentinel` es el punto de entrada principal. Implementa la lógica de negocio y orquesta las operaciones de seguridad.

**Responsabilidades:**
- `analyze_malware()`: Ejecuta el método especializado del producto
...
**Modelos Principales:**
- `ModuleConfig`: Configuration model for delaunay_sentinel
