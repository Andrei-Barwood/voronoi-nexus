# Arquitectura - geodesic_pursuit

## Visión General

geodesic_pursuit es un módulo de ciberseguridad implementado como parte del **Snocomm Security Suite**.

- **Misión**: American Venom
- **Rol de Seguridad**: apt-hunter
...
La clase `GeodesicPursuit` es el punto de entrada principal. Implementa la lógica de negocio y orquesta las operaciones de seguridad.

**Responsabilidades:**
- `hunt_apt()`: Ejecuta el método especializado del producto
...
**Modelos Principales:**
- `ModuleConfig`: Configuration model for geodesic_pursuit
