# Arquitectura - helly_rules

## Visión General

helly_rules es un módulo de ciberseguridad implementado como parte del **Snocomm Security Suite**.

- **Misión**: Charlotte Balfour
- **Rol de Seguridad**: yara-rule-engine
- **Nivel**: Production (v3.0.0)
- **Versión**: 3.0.0

## Propósito

Compila y ejecuta reglas YARA para deteccion de artefactos maliciosos.

## Estructura del Componente

### 1. Core Module (`core.py`)

La clase `HellyRules` es el punto de entrada principal. Implementa la lógica de negocio y orquesta las operaciones de seguridad.

**Responsabilidades:**
- `execute_yara()`: Ejecuta el método especializado del producto
...
**Modelos Principales:**
- `ModuleConfig`: Configuration model for helly_rules
