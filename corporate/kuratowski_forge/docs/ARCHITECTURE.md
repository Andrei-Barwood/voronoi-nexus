# Arquitectura - kuratowski_forge

## Visión General

kuratowski_forge es un módulo de ciberseguridad implementado como parte del **Snocomm Security Suite**.

- **Misión**: Red Dead Redemption
- **Rol de Seguridad**: disassembler
...
La clase `KuratowskiForge` es el punto de entrada principal. Implementa la lógica de negocio y orquesta las operaciones de seguridad.

**Responsabilidades:**
- `disassemble_binary()`: Ejecuta el método especializado del producto
...
**Modelos Principales:**
- `ModuleConfig`: Configuration model for kuratowski_forge
