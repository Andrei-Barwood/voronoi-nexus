...
```python
RadonVeilbreak(config: Optional[Dict[str, Any]] = None)
```
...
#### `detect_steganography(artifact_data)`

Ejecuta el método especializado del producto.

#### `analyze(artifact_data)`
...
Configuration model for radon_veilbreak
