# Arquitectura - radon_veilbreak

## Visión General

radon_veilbreak es un módulo de ciberseguridad implementado como parte del **Snocomm Security Suite**.

- **Misión**: Paradise Mercifully Departed
- **Rol de Seguridad**: steganography-detector
...
La clase `RadonVeilbreak` es el punto de entrada principal. Implementa la lógica de negocio y orquesta las operaciones de seguridad.

**Responsabilidades:**
- `detect_steganography()`: Ejecuta el método especializado del producto
...
**Modelos Principales:**
- `ModuleConfig`: Configuration model for radon_veilbreak
