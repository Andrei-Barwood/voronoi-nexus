# Arquitectura - voronoi_reclaim

## Visión General

voronoi_reclaim es un módulo de ciberseguridad implementado como parte del **Snocomm Security Suite**.

- **Misión**: Revenge
- **Rol de Seguridad**: ransomware-detector
...
La clase `VoronoiReclaim` es el punto de entrada principal. Implementa la lógica de negocio y orquesta las operaciones de seguridad.

**Responsabilidades:**
- `detect_ransomware()`: Ejecuta el método especializado del producto
...
**Modelos Principales:**
- `ModuleConfig`: Configuration model for voronoi_reclaim
